...
function Card({title,img, author , summary,date}) {
  return (
    <div class = 'flex flex-col shadow-lg rounded h-4/5 mx-6 my-4 w-1/2 text-gray-500 m-3'>
        <img src={img} class = ' rounded-t-lg h-[350px]'/>
        <div class = 'flex flex-col p-4 '>
            <h1 class = 'font-bold h-1/2 m-2'>{title}</h1>
            <section class = 'm-2 flex' ><span class = 'border-r-2 pr-2'>< AccountCircleIcon style={{height :'30px',width : '30px'}}/> {author}</span> <p class = 'pl-2'>{date}</p></section>
